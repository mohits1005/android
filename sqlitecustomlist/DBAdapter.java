package com.example.mohitsharma.androidsqlitelistpopulatepractise;
...
public class DBAdapter {
    ...
    public boolean updateRowText(String name){
        String where = KEY_NAME + "='" + name+"'";
        ContentValues newValues = new ContentValues();
        newValues.put(KEY_NAME, "moh");
        newValues.put(KEY_STUDENTNUM, 353);
        newValues.put(KEY_FAVCOLOUR, "red");
        return db.update(DATABASE_TABLE, newValues, where, null) != 0;
    }
